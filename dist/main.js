...
//#endregion
//#region .tmp/offline-compiler-bench/rolldown-react-1/src/main.tsx
var import_react = require_react();
var import_client = require_client();
var import_jsx_runtime = require_jsx_runtime();
function App() {
	const [count, setCount] = (0, import_react.useState)(0);
	const rows = (0, import_react.useMemo)(() => Array.from({ length: 100 }, (_, index) => index + count), [count]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "React offline compiler bench" }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			onClick: () => setCount((value) => value + 1),
			children: ["Count ", count]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Row ", row] }, row)) })
	] }) });
}
